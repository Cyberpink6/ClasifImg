# -*- coding: utf-8 -*-
"""Binario Nodule.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1VzHC5zqoTXHkMTz0iJy-oB3rmgqQA3qz
...
base_dir = '/content/drive/MyDrive/Binario Nodule'
...
df.to_csv('/content/drive/MyDrive/Binario Nodule/dataset.csv', index=False)

"""##Leer los datos de las imágenes"""

# Leer el archivo CSV
data = pd.read_csv('/content/drive/MyDrive/Binario Nodule/dataset.csv')
...
model.save('modelo_binario_nodule.h5')
